...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        if len(contents) > volume:
            self.contents = ''
            self.overflow = contents
        else:
            self.contents = contents
            self.overflow = ''
        self.volume = volume
        self.og_con=self.contents
        self.og_vol=self.volume
        self.history = []
    ...
    def append_string(self, additional_contents):
        ...
        if len(self.contents) > self.volume:
            overflow = self.contents[self.volume:len(self.contents)]
    ...
    def reset(self):
        ...
        self.volume=self.og_vol
        self.contents=self.og_con
